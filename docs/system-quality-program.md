...
| Signal | Now | Command |
|---|---|---|
| Type escapes (AST) | 11,419 total — 8,649 `: any`, 2,768 `as any`, 2 suppressions | `npm run audit:type-escapes` |
...
| Write routes covered only by the guard sweep | 211 of 328 | `npm run audit:write-routes` |
