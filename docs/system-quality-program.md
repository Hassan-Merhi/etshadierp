...
| Signal | Now | Command |
|---|---|---|
| Type escapes (AST) | 8,646 total | `npm run audit:type-escapes` |
| ESLint warnings | 9,270 total | `npm run lint` |
...
| God-file backlog | 49 files, 25,442 excess lines | `npm run audit:god-files` |
