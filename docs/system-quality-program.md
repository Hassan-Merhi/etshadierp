...
| Signal | Now | Command |
|---|---|---|
| Type escapes (AST) | 11,398 total — 8,649 `: any`, 2,747 `as any`, 2 suppressions | `npm run audit:type-escapes` |
...
| Write routes covered only by the guard sweep | 198 of 328 | `npm run audit:write-routes` |
