...
export const applicationTranslations = {
  ...
  "accessibility.skipToMainContent": { en: "Skip to main content", ar: "الانتقال إلى المحتوى الرئيسي", fr: "Aller au contenu principal" },
  ...
  "accessibility.toggleSidebar": { en: "Toggle Sidebar", ar: "فتح أو إغلاق شريط التنقل الجانبي", fr: "Afficher ou masquer la barre de navigation" },
  ...
  "workspace.controls": { en: "Workspace controls", ar: "عناصر تحكم مساحة العمل", fr: "Commandes de l’espace de travail" },
  ...
  "workspace.search": { en: "Search the workspace", ar: "البحث في مساحة العمل", fr: "Rechercher dans l’espace de travail" },
  ...
  "company.loadingSelector": { en: "Loading company selector", ar: "جارٍ تحميل محدد الشركة", fr: "Chargement du sélecteur de société" },
  ...
  "common.updateDescription": { en: "A new version of the app is ready.", ar: "نسخة جديدة من التطبيق جاهزة.", fr: "Une nouvelle version de l’application est prête." },
  ...
  "factory.overviewDescription": { en: "Manufacturing overview — output metrics & bale lifecycle", ar: "نظرة عامة على التصنيع — مؤشرات الإنتاج ودورة حياة البالات", fr: "Vue d’ensemble de la fabrication — indicateurs de production et cycle de vie des balles" },
  ...
  "daybook.allFactoryTransactions": { en: "All factory transactions in one view", ar: "جميع معاملات المصنع في عرض واحد", fr: "Toutes les transactions de l’usine dans une seule vue" },

  "settings.usersPermissions": { en: "Users & Permissions", ar: "المستخدمون والصلاحيات", fr: "Utilisateurs et autorisations" },
  "settings.manageUsersRoles": { en: "Manage users and role assignments.", ar: "إدارة المستخدمين وتعيينات الأدوار.", fr: "Gérez les utilisateurs et l’attribution des rôles." },
  "settings.userManagement": { en: "User Management", ar: "إدارة المستخدمين", fr: "Gestion des utilisateurs" },
  "settings.selectUser": { en: "Select a user to manage their account, access, and permissions.", ar: "اختر مستخدمًا لإدارة حسابه ووصوله وصلاحياته.", fr: "Sélectionnez un utilisateur pour gérer son compte, ses accès et ses autorisations." },
  ...
  "payroll.description": { en: "Workers, employees and insurance management", ar: "إدارة العمال والموظفين والتأمين", fr: "Gestion des travailleurs, employés et assurances" },
  ...
  "payroll.searchPlaceholder": { en: "Search by name, code, position, nationality...", ar: "البحث بالاسم أو الرمز أو المنصب أو الجنسية...", fr: "Rechercher par nom, code, poste ou nationalité..." },
  ...
  "pos.stockTransferDescription": { en: "Transfer stock between locations", ar: "نقل المخزون بين المواقع", fr: "Transférer le stock entre les emplacements" },
