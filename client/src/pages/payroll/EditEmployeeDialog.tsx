                          ...
                          render={({ field: scField }) => (
                            ...
                            >
                              <SelectTrigger
                                ...
                                data-testid="select-edit-bonus-pct-source-company"
                              >
                        ...
                        render={({ field: locField }) => (
                          <Select value={locField.value || ""} onValueChange={locField.onChange}>
                            <SelectTrigger
                              ...
                              data-testid="select-edit-bonus-pct-location"
                            >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    variant="outline"
                    onClick={() =>
                      setEditBaleRates((prev) => [...prev, { locationId: "", rate: "", sourceCompanyId: "" }])
                    }
                ...
                {editBaleRates.length === 0 && (
                  <p className="text-xs text-muted-foreground">
                    No per-location rates configured. Add locations to enable auto-calculation.
                  </p>
                )}
                    ...
                    <div key={idx} className="flex gap-2 items-start flex-wrap">
                      {otherCompanies.length > 0 && (
                        <Select
                          value={rowCompanyId}
                          onValueChange={(v) =>
                            setEditBaleRates((prev) =>
                              prev.map((r, i) =>
                                i === idx ? { ...r, sourceCompanyId: v === "__current__" ? "" : v, locationId: "" } : r
                              )
                            )
                          }
                        >
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          setEditBaleRates((prev) => prev.map((r, i) => (i === idx ? { ...r, locationId: v } : r)))
                        }
                      >
                        <SelectTrigger
                          className="flex-1 min-w-[120px]"
                          data-testid={`select-bale-rate-location-${idx}`}
                        >
                          <SelectValue placeholder="Select location" />
                        </SelectTrigger>
                        <SelectContent>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between flex-wrap gap-1">
                  ...
                  <Button
                    ...
                    variant="outline"
                    onClick={() =>
                      setEditBalePctRates((prev) => [...prev, { locationId: "", pct: "", sourceCompanyId: "" }])
                    }
                  ...
                  return (
                    <div key={idx} className="flex gap-2 items-start flex-wrap">
                      ...
                      <Select
                        value={row.locationId}
                        onValueChange={(v) =>
                          setEditBalePctRates((prev) => prev.map((r, i) => (i === idx ? { ...r, locationId: v } : r)))
                        }
                      >
                        <SelectTrigger
                          className="flex-1 min-w-[120px]"
                          data-testid={`select-bale-pct-rate-location-${idx}`}
                        >
                          <SelectValue placeholder="Select location" />
                        </SelectTrigger>
                        <SelectContent>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setEditBalePctRates((prev) =>
                            prev.map((r, i) => (i === idx ? { ...r, pct: e.target.value } : r))
                          )
                        }
