...
import {Building2, ChevronDown, ChevronRight, CheckCircle2, XCircle, AlertTriangle, RefreshCw, RotateCcw, Plus, DollarSign, Package, FileText, Layers, Lock} from "lucide-react";

import type {Company, GcPreview, MigrationRun} from "./gclshimigration/types";
import {StatusBadge} from "./gclshimigration/components/StatusBadge";
import {Stage2StepRunner} from "./gclshimigration/components/Stage2StepRunner";
import {ProfitOpeningRunner} from "./gclshimigration/components/ProfitOpeningRunner";
import {ReconciliationRunner} from "./gclshimigration/components/ReconciliationRunner";
// ── Types ──────────────────────────────────────────────────────────────────
                  ...
                  onClick={() => {
                    const accounts = accountPlan.accounts
                      ...
                      .map((a) => {
                        ...
                        return {
                          subType: a.subType,
                          code: edit?.code ?? a.currentCode,
                          name: edit?.name ?? a.currentName,
                        };
                      });
                    if (!accounts.length) {
