...
import { Loader2, BarChart3, CreditCard, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="space-y-4 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Payable statement and Profit & Loss</p>
      </div>
