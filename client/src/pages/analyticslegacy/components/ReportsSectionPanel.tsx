...
import { DollarSign, ChevronRight, ChevronDown, BarChart3 } from "lucide-react";

import type { AnalyticsLegacyState } from "../useAnalyticsLegacy";

export function ReportsSectionPanel({ analytics }: { analytics: AnalyticsLegacyState }) {
  const {
    activeSection,
    appMode,
                              ...
                              >
                                <span className="flex items-center gap-2">
                                  ...
                                  {nonZeroIndirectExp.length > 0 && (
                                    <span className="text-xs text-muted-foreground">({nonZeroIndirectExp.length})</span>
                                  )}
                                </span>
                                <span className="font-mono">
                              ...
                              >
                                <span className="flex items-center gap-2">
                                  ...
                                  {nonZeroIndirectInc.length > 0 && (
                                    <span className="text-xs text-muted-foreground">({nonZeroIndirectInc.length})</span>
                                  )}
                                </span>
                                <span className="font-mono">
