...
export function GoldenCoastPosReadinessAlert({ blockers = [] }: GoldenCoastPosReadinessAlertProps) {
  return (
    <div
      role="alert"
    ...
    >
      ...
      <div className="min-w-0 space-y-1.5 text-sm">
        ...
        <p>
          Golden Coast sales use the company’s current inventory cost. Resolve the accounting setup issue below to
          continue.
        </p>
        {blockers.length > 0 && (
