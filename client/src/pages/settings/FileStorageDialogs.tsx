...
export function FileStorageDialogs({
  newFolderOpen, setNewFolderOpen, newFolderName, setNewFolderName, createFolderMutation,
  renameFolderOpen, setRenameFolderOpen, renameFolderName, setRenameFolderName, renameFolderId, renameFolderMutation,
  deleteFolderId, setDeleteFolderId, deleteFolderName, deleteFolderHasFiles, deleteFolderMutation,
  renameFileOpen, setRenameFileOpen, renameFileName, setRenameFileName, renameFileId, renameFileMutation,
  moveFileOpen, setMoveFileOpen, moveFileId, moveFolderTarget, setMoveFolderTarget, folders, moveFileMutation,
  deleteFileId, setDeleteFileId, deleteFileName, deleteFileMutation
}: any) {
  return (
    <>
      {/* ── New Folder Dialog ────────────────────────────────────────────────── */}
