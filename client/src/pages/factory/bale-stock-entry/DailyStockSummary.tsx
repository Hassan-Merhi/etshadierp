  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border bg-orange-500/10 border-orange-500/20">
        ...
        <span className="text-sm font-bold tabular-nums text-orange-600 dark:text-orange-400" data-testid="text-entry-today-garbage-qty">{garbageQty}</span>
        <span className="text-xs text-orange-600/70 dark:text-orange-400/70">bales</span>
        <span className="w-px h-3 bg-orange-500/30" />
        <span className="text-sm font-bold tabular-nums text-orange-600 dark:text-orange-400" data-testid="text-entry-today-garbage-kg">{formatDailyNum(garbageKg)}</span>
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border bg-blue-500/10 border-blue-500/20">
        ...
        <span className="text-sm font-bold tabular-nums text-blue-600 dark:text-blue-400" data-testid="text-entry-today-wipers-qty">{wipersQty}</span>
        <span className="text-xs text-blue-600/70 dark:text-blue-400/70">bales</span>
        <span className="w-px h-3 bg-blue-500/30" />
        <span className="text-sm font-bold tabular-nums text-blue-600 dark:text-blue-400" data-testid="text-entry-today-wipers-kg">{formatDailyNum(wipersKg)}</span>
