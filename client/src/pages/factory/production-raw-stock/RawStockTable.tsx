        ...
        <Table>
          <TableHeader className="bg-muted/50">
            <TableRow className="hover:bg-transparent">
              <TableHead className="w-[300px] py-4">{tUi("source.supplier.2")}</TableHead>
              <TableHead className="text-right py-4">{tUi("total.received")}</TableHead>
              <TableHead className="text-right py-4">{tUi("total.used")}</TableHead>
              <TableHead className="text-right py-4">{tUi("reserved.mix")}</TableHead>
              <TableHead className="text-right py-4 font-semibold text-foreground">{tUi("available.free")}</TableHead>
              <TableHead className="text-right py-4">{tUi("value.usd")}</TableHead>
                          ...
                          <TableCell className="py-3 text-right pr-4">
                            <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <Button
                                ...
                                title={tUi("adjust.stock.cost.qty")}
                              ...
                              <Button
                                ...
                                title={tUi("deduct.damaged.wasted.stock")}
