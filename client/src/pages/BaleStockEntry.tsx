  ...
  function generateCombinedLabelsHtml(labels: LabelData[], designColor?: A4DesignColor) {
    ...
    return `<html><head><title>Stock Entry Labels - A4</title><style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .barcode-subtext { font-size: 10pt; font-weight: 900; margin-top: 0.3mm; text-transform: uppercase; letter-spacing: 1px; line-height: 1.1; word-break: break-word; -webkit-text-stroke: 0.4px #000; }
  ...
  function generateStickerLabelsHtml(labels: LabelData[]) {
    ...
    return `<html><head><title>Sticker Labels</title><style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
      ...
      .ref-bale-name { font-size: 9pt; font-weight: 900; margin-top: 0.2mm; text-transform: uppercase; letter-spacing: 1px; line-height: 1.1; word-break: break-word; -webkit-text-stroke: 0.4px #000; }
