...
export const STATUS_META: Record<string, { color: string; icon: React.ReactNode }> = {
  OTW:          { color: "bg-sky-100 text-sky-800 dark:bg-sky-900/30 dark:text-sky-300",             icon: React.createElement(Ship, { className: "h-3 w-3" }) },
  Sea:          { color: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",          icon: React.createElement(Ship, { className: "h-3 w-3" }) },
  "At Port":    { color: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300",      icon: React.createElement(Package, { className: "h-3 w-3" }) },
  "Left Dar":   { color: "bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-300",  icon: React.createElement(Truck, { className: "h-3 w-3" }) },
  "At Border":  { color: "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300",  icon: React.createElement(Truck, { className: "h-3 w-3" }) },
  "In Transit": { color: "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300",  icon: React.createElement(Truck, { className: "h-3 w-3" }) },
  Arrived:      { color: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",      icon: React.createElement(CheckCircle2, { className: "h-3 w-3" }) },
  Offloaded:    { color: "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300",             icon: React.createElement(Package, { className: "h-3 w-3" }) },
  Closed:       { color: "bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-500",             icon: React.createElement(XCircle, { className: "h-3 w-3" }) },
  Completed:    { color: "bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-500",             icon: React.createElement(XCircle, { className: "h-3 w-3" }) },
};
