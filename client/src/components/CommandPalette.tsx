...
const DESCRIPTIONS: Record<string, string> = {
  ...
  "/factory/accounting-hub": "Accounting vouchers and chart of accounts",
...
const FACTORY_HUB_TABS: PageEntry[] = [
  ...
  { label: "Accounting",          description: DESCRIPTIONS["/factory/accounting-hub"],              path: "/factory/accounting-hub",                                   icon: FileText },
  { label: "Vouchers",            description: DESCRIPTIONS["/factory/vouchers"],                    path: "/factory/accounting-hub?section=vouchers",                  icon: FileText },
  { label: "Chart of Accounts",   description: DESCRIPTIONS["/factory/accounts"],                    path: "/factory/accounting-hub?section=accounts",                  icon: PieChart },
