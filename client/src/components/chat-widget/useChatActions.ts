...
interface ChatActionsState {
  ...
  setPendingStockAdj: (v: unknown) => void;
  setPendingStockTransfer: (v: unknown) => void;
  setPendingStockTransferBatch: (v: StockTransferDraft[] | null) => void;
  setVoucherSearchResults: (v: unknown) => void;
  setPendingStockItem: (v: unknown) => void;
  setPendingPriceUpdate: (v: unknown) => void;
  setAccountQueryResult: (v: unknown) => void;
  setVerifyContainerDraft: (v: unknown) => void;
  setDataQueryResult: (v: unknown) => void;
