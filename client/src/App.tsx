...
const FactoryDaybook = lazy(() => import("@/pages/FactoryDaybook"));
...
const FactoryLocationInventory = lazy(() => import("@/pages/FactoryLocationInventory"));
...
const FactoryStockItemDetail = lazy(() => import("@/pages/FactoryStockItemDetail"));
const SalesReport = lazy(() => import("@/pages/SalesReport"));
const POSDaybook = lazy(() => import("@/pages/POSDaybook"));
const POSDashboard = lazy(() => import("@/pages/POSDashboard"));
const POSCustomers = lazy(() => import("@/pages/POSCustomers"));
const POSSettings = lazy(() => import("@/pages/POSSettings"));
const POSPriceList = lazy(() => import("@/pages/POSPriceList"));
...
const FactoryProduction = lazy(() => import("@/pages/FactoryProduction"));
const ProductionRawStock = lazy(() => import("@/pages/ProductionRawStock"));
const FactoryOpeningBalanceEdit = lazy(() => import("@/pages/FactoryOpeningBalanceEdit"));
const PressingBales = lazy(() => import("@/pages/PressingBales"));
const BaleStockEntry = lazy(() => import("@/pages/BaleStockEntry"));
const BalesHistory = lazy(() => import("@/pages/BalesHistory"));
const FactoryBaleProductHistory = lazy(() => import("@/pages/FactoryBaleProductHistory"));
...
const FactorySuppliers = lazy(() => import("@/pages/FactorySuppliers"));
const FactoryContainers = lazy(() => import("@/pages/FactoryContainers"));
const FactoryContainerCreate = lazy(() => import("@/pages/FactoryContainerCreate"));
...
const FactoryFinancialSnapshot = lazy(() => import("@/pages/FactoryFinancialSnapshot"));
...
const FactoryCustomers = lazy(() => import("@/pages/FactoryCustomers"));
const FactoryCustomerStatement = lazy(() => import("@/pages/FactoryCustomerStatement"));
const FactoryInvoicing = lazy(() => import("@/pages/FactoryInvoicing"));
const FactoryInvoices = lazy(() => import("@/pages/FactoryInvoices"));
...
const FactoryStockAllocation = lazy(() => import("@/pages/FactoryStockAllocation"));
const ProformaAddLine = lazy(() => import("@/pages/ProformaAddLine"));
...
const FactoryContainerLoadingScan = lazy(() => import("@/pages/FactoryContainerLoadingScan"));
const FactoryDashboardIntel = lazy(() => import("@/pages/FactoryDashboard"));
const FactoryKpis = lazy(() => import("@/pages/FactoryKpis"));
const FactoryProfitability = lazy(() => import("@/pages/FactoryProfitability"));
const FactoryAlerts = lazy(() => import("@/pages/FactoryAlerts"));
const FactorySupplierScoreboard = lazy(() => import("@/pages/FactorySupplierScoreboard"));
