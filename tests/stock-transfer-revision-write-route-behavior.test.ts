...
describe("stock transfer revision write routes", () => {
  ...
  // Approval moved to stockTransferRevisionLifecycleRoutes and is covered by
  // tests/stock-transfer-revision-lifecycle.test.ts. This suite only exercises
  // the legacy create/metadata routes still registered by revisions-write.ts.
