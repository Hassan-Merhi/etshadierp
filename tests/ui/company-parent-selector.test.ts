...
const companiesTab = fs.readFileSync(
  path.resolve(process.cwd(), "client/src/pages/settings/CompaniesTab.tsx"),
  "utf8"
);
const setupPanel = fs.readFileSync(
  path.resolve(process.cwd(), "client/src/pages/sp/SpSetupPanel.tsx"),
  "utf8"
);
