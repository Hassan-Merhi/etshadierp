...
describe("Historical Replay dependency graph", () => {
  it("does not treat two source rows from the same upstream batch as a cycle", () => {
    ...
    const sources: SourceInfo[] = [
      { sourceId: 1, batchId: 10, batchCode: "B10", batchDate: "2026-01-01", supplierId: 1, containerId: 100, sourceBatchId: null, weightKg: 100, storedCostPerKg: 1, storedTotalCost: 100, pricingBasis: "SUPPLIER_LOCKED_RATE" },
      { sourceId: 2, batchId: 20, batchCode: "B20", batchDate: "2026-01-02", supplierId: null, containerId: null, sourceBatchId: 10, weightKg: 40, storedCostPerKg: 1, storedTotalCost: 40, pricingBasis: "BATCH" },
      { sourceId: 3, batchId: 20, batchCode: "B20", batchDate: "2026-01-02", supplierId: null, containerId: null, sourceBatchId: 10, weightKg: 60, storedCostPerKg: 1, storedTotalCost: 60, pricingBasis: "BATCH" },
    ];
